    ...
    <div class="md-5"><!-- Comienza Row -->
        <form action="update.php" method="post" class="form-group">
            ...
            <div class="form-row">
                ...
                <input type="text" name="carnet" class="form-control" value="<?php echo ($persona->ci_solicitante); ?>">
            </div>
            ...
            <div class="form-row">
                ...
                <input type="text" name="cantidad" class="form-control" value="<?php echo ($persona->cant_tramites); ?>">
            </div>
